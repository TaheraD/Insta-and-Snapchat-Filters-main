...
def calc_incl(p1, p2):
	...
	incl = 180/math.pi*math.atan((float(y2-y1))/(x2-x1))      #to find arc tangent use atan()
	return incl

def apply_sprite(frame, p2sprite, w, x, y, angle, ontop = True):
	sprite = cv2.imread(p2sprite, -1)        #-1 unchanged, 1 greyscale
	sprite = rotate_bound(sprite, angle)      # angle clockwise, anticlockwise e.g. cv2.ROTATE_90_CLOCKWISE
...
def adjust_sprite2head(sprite, head_w, head_y, ontop = True):
	...
	factor = 1.0*head_w/w_sprite       #for getting pos to locate sprite
	sprite = cv2.resize(sprite, (0,0), fx=factor, fy=factor)    #args: src, desired size for o/p, xfactor, yfactor
	(h_sprite, w_sprite) = (sprite.shape[0], sprite.shape[1])
...
dir_ = 'C:/Users/pc/Downloads/Insta-and-Snapchat-Filters-main/Insta-and-Snapchat-Filters-main/Snapchat Filter/sprites/googlies/'
googlies = [f for f in listdir(dir_) if isfile(join(dir_, f))]
i = 0
dir1 = 'C:/Users/pc/Downloads/Insta-and-Snapchat-Filters-main/Insta-and-Snapchat-Filters-main/Snapchat Filter/sprites/clouds/'
...
model = r'C:\Users\pc\Downloads\Insta-and-Snapchat-Filters-main\Insta-and-Snapchat-Filters-main\Snapchat Filter\filters\shape_predictor_68_face_landmarks.dat'
...
while True:
	...
	for face in faces:
		...
		apply_sprite(frame, r'C:\Users\pc\Downloads\Insta-and-Snapchat-Filters-main\Insta-and-Snapchat-Filters-main\Snapchat Filter\sprites\nosepick.png', w2, x2-15, y2+25, incl, ontop = False)
		if mouth_open:
			apply_sprite(frame, r'C:\Users\pc\Downloads\Insta-and-Snapchat-Filters-main\Insta-and-Snapchat-Filters-main\Snapchat Filter\sprites\rainbow.png', w0, x0, y0, incl, ontop = False)
